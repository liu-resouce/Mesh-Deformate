...
namespace Dest.Math
{
	public class CubicSpline3 : SplineBase
	{
	    ...
	    public static CubicSpline3 Create(Transform t, List<Vector3> points, SplineTypes type)
	    {
	        CubicSpline3 spline = t.GetComponent<CubicSpline3>();
	        if (spline == null)
	        {
	            spline = t.gameObject.AddComponent<CubicSpline3>();
	        }
